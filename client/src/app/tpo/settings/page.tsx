...
import { Lock, Bell, Save, Loader2, Trash2, Shield } from 'lucide-react'
  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <div className="glass-card p-6">
        ...
        <p className="text-sm text-aura-muted">You receive alerts for new company KYC submissions, student at-risk triggers, and placement updates.</p>
      </div>
      ...
      <div className="glass-card p-6 border-red-500/20">
        ...
        <p className="text-sm text-aura-muted mb-4">Deleting the university account will remove all student and placement records permanently.</p>
        <button
          onClick={() => {
            if (!confirm('Delete university account permanently?')) return
